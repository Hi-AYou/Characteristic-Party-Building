...
COLUMN_MAP = {
    ...
    "是否保留党籍": "retain_party_membership",
    "备注": "notes",
    # 发展进度日期
    ...
    "入党积极分子党委备案日期": "activist_committee_filing_date",
    "积极分子党委备案日期": "activist_committee_filing_date",
    ...
    "接收预备党员党委预审日期": "probationary_committee_pre_review_date",
    "接收预备党员党委审批日期": "probationary_committee_approval_date",
    "预备党员日期": "probationary_date", "成为预备党员日期": "probationary_date",
    "接收为预备党员日期": "probationary_date",
    "入党宣誓日期": "party_oath_date",
    "预备党员转正党委预审日期": "full_member_committee_pre_review_date",
    "预备党员转正支部大会日期": "full_member_branch_meeting_date",
    "预备党员转正党委审批日期": "full_member_committee_approval_date",
    "入党日期": "full_member_date",
...
BOOL_FIELDS = {"is_overseas", "retain_party_membership"}
...
EXPORT_FIXED_COLS = [
    ...
    ("is_overseas",                        "是否海外交流"),
    ("retain_party_membership",            "是否保留党籍"),
    ("current_stage",                      "当前阶段"),
    ("application_date",                   "递交入党申请书日期"),
    ("youth_league_graduation_date",       "团校结业日期"),
    ("activist_confirmed_date",            "积极分子确立日期"),
    ("activist_committee_filing_date",     "入党积极分子党委备案日期"),
    ("activist_training_graduation_date",  "积极分子培训班结业日期"),
    ("dev_target_confirmed_date",          "发展对象确立日期"),
    ("dev_training_graduation_date",       "发展对象培训班结业日期"),
    ("probationary_committee_pre_review_date", "接收预备党员党委预审日期"),
    ("probationary_committee_approval_date",   "接收预备党员党委审批日期"),
    ("probationary_date",                      "预备党员日期"),
    ("party_oath_date",                        "入党宣誓日期"),
    ("full_member_committee_pre_review_date",  "预备党员转正党委预审日期"),
    ("full_member_branch_meeting_date",        "预备党员转正支部大会日期"),
    ("full_member_committee_approval_date",    "预备党员转正党委审批日期"),
    ("full_member_date",                       "入党日期"),
    ("updated_at",                         "最后更新时间"),
...
TEMPLATE_COLS = [
    ...
    "党支部内职务", "是否海外交流", "是否保留党籍",
    "递交入党申请书日期", "团校结业日期",
    "积极分子确立日期", "入党积极分子党委备案日期", "积极分子培训班结业日期",
    "发展对象确立日期", "发展对象培训班结业日期",
    "接收预备党员党委预审日期", "接收预备党员党委审批日期",
    "预备党员日期", "入党宣誓日期",
    "预备党员转正党委预审日期", "预备党员转正支部大会日期", "预备党员转正党委审批日期",
    "入党日期", "备注",
]
